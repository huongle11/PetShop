...
@section('content')
<div class="container">
  <div  style="height:95px;width:100%;background-color:hsl(15, 84%, 57%);position:absolute;top:0;left:0;"></div>
  <main id="" class="main card"  style="margin-top:115px;padding:20px">
